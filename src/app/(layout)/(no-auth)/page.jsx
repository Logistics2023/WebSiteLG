              ...
              {element === 'FTL' && calcValue === 'NO DATA' && calcValueFCL === 'NO DATA' &&
                <form className="space-y-5 lg:space-y-0  py-5 lg:grid lg:grid-cols-2 lg:gap-5" onSubmit={calculator}>
                  ...
                  <div className='flex  justify-around col-span-2'>
                    ...
                    {inputRef.current && inputRef2.current && Object.values(cliente.priceFTL) && Object.values(cliente.priceFTL).filter((i) => i.ORIGEN === inputRef.current.value && i.DESTINO === inputRef2.current.value) && Object.values(cliente.priceFTL).filter((i) => i.ORIGEN === inputRef.current.value && i.DESTINO === inputRef2.current.value&& i.MERCANCIA === selectValue.MERCANCIA).map((i) => i['SERVICIO']).includes('CON DEVOLUCION') && <div class="flex items-center">
